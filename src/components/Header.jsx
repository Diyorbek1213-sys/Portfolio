...
const Header = () => {
  ...
  return (
    <header className="bg-[#1A0B2E]/20 backdrop-blur-lg py-4 md:py-6 lg:py-[32px] px-4 sm:px-6 md:px-10 lg:px-[200px] flex justify-between items-center fixed top-0 left-0 w-full text-white z-50">
      ...
      <div className="hidden lg:block">
        <nav>
          <ul className="flex items-center gap-8 xl:gap-[168px]">
            <li className="text-white font-[jakarta] font-semibold tracking-[0.32px]">
              <Link
                to="about"
                smooth={true}
                duration={1000}
                offset={-500}
                className="cursor-pointer hover:text-gray-400 hover:underline transition-all"
              >
                About
              </Link>
            </li>
      ...
      {/* Mobile navigation */}
      {isMenuOpen && (
        <div className="lg:hidden absolute top-full left-0 right-0 bg-[#1A0B2E] py-4">
          <nav>
