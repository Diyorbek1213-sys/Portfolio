        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-16">
            ...
            <motion.div
              ...
              className="flex backdrop-blur-md gap-6 p-6 border-t-4 border-[#4F228D] rounded-xl shadow-lg bg-gradient-to-r from-[#130428]/30 via-[#251043]/30 to-[#190634]/30 h-full"
            >
